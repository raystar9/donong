...
<div class="navbar">
	<div class="navbar-header">
		<a class="dropdown" href="/donong/main">
			<img id="logo" src="/donong/resources/main/image/logo.jpg">
		</a>
	</div>
	<div class="collapse navbar-collapse">
		<ul class="nav navbar-nav">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					<li><a href="/donong/cs">메인</a></li>
					<li><a href="/donong/cs/qna">QnA</a></li>
					<li><a href="/donong/cs/notice">공지사항</a></li>
				</ul>
			</li>
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<c:if test='${sessionBean.nickname != null }'>
				<li>
					<a href="member_mypage">${sessionBean.nickname}님 마실나오셨네요</a>
				</li>
				<li>
					<a href="member_mypage">
						<span class="glyphicon glyphicon-pencil"></span> My Page
					</a>
				</li>
				<li>
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<div class="checkbox text-left">
										<label>
											<input type="checkbox" name="saveid" id="saveid" <c:if test="${!empty saveid}">checked</c:if>>
											Remember ID
										</label>
									</div>
									<div class="find text-right">
										<div>
											<a onclick="id_find()">ID찾기</a>/<a onclick="pwd_find()">비밀번호찾기</a>
										</div>
									</div>
								</div>
							</div>

...
<div class="container text-center">
	...
	<form name="joinform" method="post" action="member_edit_ok" class="form-horizontal" onsubmit="return check()">
	
		<div id="edit_table">
		<div class=title>
					<div class="form-group">
					<h2 class="col-sm-12">회원정보 수정 페이지</h2>
					</div>
			</div>	
			...
			<div class="col-sm-2"></div>
				...
				<div class="col-sm-3">
					<input name="realname" id="join_name" class="form-control" placeholder="실제성명을 입력해주세요." readonly required value="${memberDTO.realname }">
				</div>
				<div class="col-sm-5"></div>
			</div>	
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" id="addrdetail" name="addressdetail" class="form-control" value="${memberDTO.addressdetail}">
					</div>
					<div class="col-sm-4"></div>
				</div>
